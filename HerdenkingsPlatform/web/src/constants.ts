...
// export const EXAMPLE_IDS = new Array<String>(["169f485d-a542-47ac-87b1-1d9bd5be569e", "d32b99a9-3583-4f61-a04f-dd6d5ffab20b", "51fc5f66-87ab-41f4-b24b-6c0eb06ae33f"]);
export const  EXAMPLE_IDS: string[] = ["169f485d-a542-47ac-87b1-1d9bd5be569e", "d32b99a9-3583-4f61-a04f-dd6d5ffab20b", "51fc5f66-87ab-41f4-b24b-6c0eb06ae33f"];
...
/**
 * Prices when choosing the basic package for montly subscriptiuon, 1,5 and 10 years respe
 */
export const PAYMENT_BASIC_PLAN: number[] = [5,50,200,250];


/**
 * Prices when choosing the premium package for montly subscriptiuon, 1,5 and 10 years respe
 */
export const PAYMENT_PREMIUM_PLAN: number[] = [5,50,200,250];
export const PAYMENT_PREMIUM_PLAN_NEXT: number[] = [10,100,400,500];