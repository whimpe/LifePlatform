...
interface Demo_CreateContent_QuestionProps {
  setModelclick: any;
  setContent:any;
  setmodalState:any;
}

export const Demo_CreateContent_Question: React.FC<Demo_CreateContent_QuestionProps> = ({ setModelclick, setContent,setmodalState }) => {
...
export default WithApollo({ ssr: false })(Demo_CreateContent_Question);
