...
export const RemovePersonModal: React.FC<RemovePersonModalProps> = ({active, setactive,execute_func,error_type }) => { 
    ...
    <div>
      ...
      >
        ...
        <DialogActions>
            ...
            {meData!.me!.status>= STATUS.CoOwner ?<Button onClick={(e:any)=>execute_func} color="primary" autoFocus>{JsonData[error_type].btn_right}</Button>:null}
        </DialogActions>
      </Dialog>
    </div>
  );
}
export default WithApollo({ ssr: false })(RemovePersonModal);
