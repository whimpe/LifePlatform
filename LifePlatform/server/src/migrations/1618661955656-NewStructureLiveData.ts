...
//         await queryRunner.query(`ALTER TABLE "herinnering" ADD "status" integer NOT NULL`);
...
//         await queryRunner.query(`ALTER TABLE "herdenkings_pagina" ADD "Payment_status" integer NOT NULL`);
//         await queryRunner.query(`ALTER TABLE "herdenkings_pagina" ADD "Payment_plan" integer NOT NULL`);
