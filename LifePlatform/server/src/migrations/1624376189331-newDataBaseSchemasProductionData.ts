...
// export class newDataBaseSchemasProductionData1624376189331 implements MigrationInterface {
//     name = 'newDataBaseSchemasProductionData1624376189331'
...
//         // await queryRunner.query(`ALTER TABLE "herinnering" ADD "status" integer NOT NULL`);b


//         await queryRunner.query(`ALTER TABLE "comment" ADD "messageId" uuid`);
//         await queryRunner.query(`ALTER TABLE "media" ADD "objectSize" integer`);
...
//         await queryRunner.query(`ALTER TABLE "herdenkings_pagina" ADD "DesignType" integer NOT NULL DEFAULT '0'`);
...
//         await queryRunner.query(`ALTER TABLE "herdenkings_pagina" ADD "number_of_bytes" integer NOT NULL DEFAULT '0'`);
//         await queryRunner.query(`ALTER TABLE "herinnering" DROP COLUMN "categorie"`);
//         await queryRunner.query(`ALTER TABLE "herinnering" ADD "categorie" integer`);
...
//         await queryRunner.query(`ALTER TABLE "herinnering" DROP COLUMN "categorie"`);
//         await queryRunner.query(`ALTER TABLE "herinnering" ADD "categorie" character varying`);
//         await queryRunner.query(`ALTER TABLE "herdenkings_pagina" DROP COLUMN "number_of_bytes"`);
...
//         await queryRunner.query(`ALTER TABLE "herdenkings_pagina" DROP COLUMN "DesignType"`);
...
//         await queryRunner.query(`ALTER TABLE "media" DROP COLUMN "objectSize"`);
